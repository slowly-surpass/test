<template>
  ...
  <el-card class="box-card">
    <div slot="header" class="clearfix">
      ...
      <div style="margin-top: 15px;">
        <el-row :gutter="10">
          ...
          <el-col :span="16">
            <el-button type="primary" @click="getStore">搜索</el-button>
    ...
    <!--仓库列表-->
    <template>
      <el-table ref="multipleTable" :data="storelist.slice((pagenum-1)*pagesize,pagenum*pagesize)" border tooltip-effect="dark" style="width: 100%"
  ...
  export default {
    ...
    methods: {
      getStore(){
        this.total = 0;
        this.storelist = [];
        this.$http.get(this.HOST+'/store', {params:{search: this.input}}).then(res=>{
          // console.log(res)
